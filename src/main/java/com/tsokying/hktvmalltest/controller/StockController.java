...
public class StockController {
    ...
    public void uploadStockData(@RequestParam("file") MultipartFile file) throws IOException {
    stockService.saveAll(CsvUtils.read(Stock.class, file.getInputStream()));
    }

    @GetMapping("/all")
    public Iterable<StockInfo> getAllStock(){
